#' @title Extract pseudo Kullback-Leibler information criterion (KLIC) for
#' multivariate covariance generalized linear models.
#' @author Wagner Hugo Bonat
#'
#' @description Extract the KLIC for a fitted McGLM.
#' @param object an object or a list of objects representing a model
#' of \code{mcglm} class.
#' @param verbose Logical
#' @return Returns the value of the KLIC.
#' @export
