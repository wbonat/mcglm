...
#'
#' @description This function update a list of covariance parameters. It will be useful only inside the
#' fitting algorithm.
#'
...
#' the output from \code{[mcglm]{getInformation}}.
#' @param list_power_fixed A list of logical indicating if the power parameter should be estimated or not.
...
updatedCov <- function(list_initial, covariance, list_power_fixed, information, n_resp){
