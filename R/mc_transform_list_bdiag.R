...
#' @description This function take a list of matrices and return a list of block-diagonal matrices,
#' where the original matrices are one block non-zero of the matrix.
#'
#' @param list_mat A list of matrices.
#' @param mat_zero A list of zero matrices. In general the output of \code{link[mcglm]{mc_build_bdiag}}.
