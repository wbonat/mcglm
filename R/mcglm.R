...
#' The models are specified by a set of lists giving a symbolic description of the linear predictor and
#' specyfing the link, variance and covariance functions.
#'
