#' Residulas for Multivariate Covariance Generalized Linear Models (McGLM)
#'
...
#' @param type the type of residuals which should be returned. The alternatives are: "ordinary"
#' (default) and "standardized".
