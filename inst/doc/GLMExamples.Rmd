---
title: "Fitting GLMs using McGLMs"
...
The orthodox quasi-Poisson model is obtained specifying the variance
function as `tweedie` and fixing the power parameter at $1$.
...
bivariate Gamma model could be suitable choice.
...
We can also easily change the link function. The code below fit a
